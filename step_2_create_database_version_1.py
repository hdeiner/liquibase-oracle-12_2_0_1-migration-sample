...
os.system('figlet -w 160 -f standard "Create Database Version 1"')
...
os.system('cp src/main/db/IMDB-schema-v1.xml src/main/db/IMDB-schema.xml')
os.system('liquibase --changeLogFile=src/main/db/IMDB-schema.xml update')
os.system('liquibase --changeLogFile=src/main/db/IMDB-schema.xml dbdoc docs/dbdoc/v1')
